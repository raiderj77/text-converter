...
const STORAGE_KEY = "fmc_strikethrough_text_generator";
...
export function StrikethroughTextGeneratorTool() {
  ...
  const output = input ? toStrikethrough(input) : "";
  ...
  const handleExample = () => {
    setInput("Strikethrough text for corrections!");
  };
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <div className={cx("rounded-xl border p-4", base)}>
          <div className="flex items-center justify-between mb-2">
            <h3 className="text-sm font-semibold">Strikethrough Output</h3>
            {output && (
              <button
                type="button"
                onClick={copyToClipboard}
          ...
          >
            {output || (
              <span className={cx("text-sm", muted)}>
                S̶t̶r̶i̶k̶e̶t̶h̶r̶o̶u̶g̶h̶ text appears here as you type...
              </span>
            )}
          </div>
          <div className={cx("mt-2 text-xs", muted)}>
