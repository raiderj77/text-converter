...
export function ToolActions() {
  ...
  return (
    <div className="flex gap-2">
      <button onClick={handlePrint} className={btnClass} type="button" aria-label="Print this page">
      ...
      <button onClick={handleShare} className={btnClass} type="button" id="share-btn" aria-label="Share link to this tool">
