    ...
    <>
      ...
      <div className="mx-auto max-w-6xl px-4 py-6">
        ...
        <div className="sr-only">
          ...
          <h2>How to Use the String Encoder Tool</h2>

          <h2>String Encoder Features and Options</h2>

          <h2>About the Free Online String Encoder</h2>
        ...
        <div className="mt-4 rounded-xl border border-white/10 bg-neutral-900/50 px-4 py-3">
          <Link
            href="/blog/string-encoder-guide"
            className="text-sm font-medium text-blue-400 hover:text-blue-300 transition-colors"
          >
            📖 Full Guide: Base64, URL, and HTML Encoder/Decoder — Free Online Tool →
          </Link>
        </div>
        ...
        <section className="mt-10">
          <h2 className="text-lg sm:text-xl font-semibold">
            Frequently Asked Questions About String Encoder
          </h2>
          <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-3">
            {faqItems.map((faq) => (
              <div
