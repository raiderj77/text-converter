  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-6xl px-4 py-6">
        ...
        <ToolAnswerBlock slug="underline-text-generator" />
        ...
        <div className="sr-only">
          ...
          <h2>How to Use the Underline Text Generator Tool</h2>

          <h2>Underline Text Generator Features and Options</h2>

          <h2>About the Free Online Underline Text Generator</h2>
        ...
        <section className="mt-10">
          <h2 className="text-lg sm:text-xl font-semibold">
            Frequently Asked Questions About Underline Text Generator
          </h2>
          <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-3">
            {faqItems.map((faq) => (
              <div
