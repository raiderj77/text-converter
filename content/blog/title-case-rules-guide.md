...
date: "2026-03-18"
keywords: ["title case rules", "title case capitalization", "AP style title case", "APA title case", "Chicago style capitalization"]
toolSlug: "toggle-case-converter"
faq:
  - question: "Do you capitalize 'the' in title case?"
    answer: "Only capitalize 'the' when it is the first or last word of a title. In all four major style guides — AP, APA, Chicago, and MLA — short articles like 'the,' 'a,' and 'an' stay lowercase when they appear in the middle of a title."
  - question: "What is the difference between AP and APA title case?"
    answer: "AP style capitalizes words with four or more letters, while APA capitalizes words with four or more letters and also capitalizes both parts of a hyphenated compound. APA also requires capitalizing the first word after a colon, which AP does not always require."
  - question: "Should prepositions be capitalized in title case?"
    answer: "Short prepositions like 'in,' 'on,' 'at,' 'to,' and 'by' stay lowercase in most style guides. Chicago capitalizes prepositions with five or more letters (like 'about' and 'between'). AP capitalizes prepositions with four or more letters."
  - question: "Is title case the same as headline case?"
    answer: "Yes. Title case and headline case refer to the same capitalization pattern where major words are capitalized and minor words stay lowercase. Some style guides call it 'headline-style capitalization' while others call it 'title case.'"
related: ["sentence-case-vs-title-case", "naming-conventions-programming-guide", "word-count-guide-seo-academic"]
---
...
1. **Always capitalize the first word** of the title, regardless of what it is.
2. **Always capitalize the last word** of the title.
3. **Capitalize all nouns, verbs, adjectives, adverbs, and pronouns.** This includes short verbs like "Is," "Are," "Be," and "Do."
4. **Lowercase articles** ("a," "an," "the") unless they are the first or last word.
5. **Lowercase coordinating conjunctions** ("and," "but," "or," "nor," "for," "yet," "so") in most positions.
...
| Word       | AP    | APA   | Chicago | MLA   |
|------------|-------|-------|---------|-------|
| the        | lower | lower | lower   | lower |
| between    | Cap   | Cap   | lower   | lower |
| from       | Cap   | Cap   | lower   | lower |
| is         | Cap   | Cap   | Cap     | Cap   |
| to (infin.)| lower | lower | lower   | lower |
| after colon| —     | Cap   | Cap     | Cap   |

## How FlipMyCase Helps

Manually checking every word against style guide rules is tedious. The [Toggle Case Converter](/toggle-case-converter) on FlipMyCase instantly converts any text to title case. Paste your headline, click one button, and get correctly capitalized output.

If you also need to clean up extra spaces, fix line breaks, or strip formatting artifacts before applying title case, run your text through the [Text Cleaner](/text-cleaner) first. Clean input produces clean output.
...
**Before:** "how to write better emails for your team at work"
**After (AP):** "How to Write Better Emails for Your Team at Work"
**After (Chicago):** "How to Write Better Emails for Your Team at Work"

**Before:** "a beginner's guide to self-publishing on amazon"
**After (AP):** "A Beginner's Guide to Self-Publishing on Amazon"
**After (APA):** "A Beginner's Guide to Self-Publishing on Amazon"
**After (Chicago):** "A Beginner's Guide to Self-Publishing on Amazon"

**Before:** "the effects of sleep deprivation on decision-making in adults"
**After (APA):** "The Effects of Sleep Deprivation on Decision-Making in Adults"
**After (Chicago):** "The Effects of Sleep Deprivation on Decision-Making in Adults"
...
**Do you capitalize 'the' in title case?**
Only capitalize 'the' when it is the first or last word of a title. In all four major style guides — AP, APA, Chicago, and MLA — short articles like 'the,' 'a,' and 'an' stay lowercase when they appear in the middle of a title.

**What is the difference between AP and APA title case?**
AP style capitalizes words with four or more letters, while APA capitalizes words with four or more letters and also capitalizes both parts of a hyphenated compound. APA also requires capitalizing the first word after a colon, which AP does not always require.

**Should prepositions be capitalized in title case?**
Short prepositions like 'in,' 'on,' 'at,' 'to,' and 'by' stay lowercase in most style guides. Chicago capitalizes prepositions with five or more letters (like 'about' and 'between'). AP capitalizes prepositions with four or more letters.
...
For fast, accurate title case conversion, use the [Toggle Case Converter](/toggle-case-converter) on FlipMyCase. Paste your text, select title case, and copy the result. No manual checking required.
