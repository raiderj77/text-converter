...
Generating Unicode styled text by hand means looking up code points and copying individual characters. The text generators at [FlipMyCase](https://flipmycase.com) make it instant.

Type your text, pick a style — bold, italic, bold italic, strikethrough, underline, small caps, bubble text, wide text, upside down — and copy the result. The [bold text generator](https://flipmycase.com/bold-text-generator) and [italic text generator](https://flipmycase.com/italic-text-generator) are the most popular tools for social media formatting.

Everything runs in your browser at [flipmycase.com](https://flipmycase.com) with no signup or character limits.
...
**Some characters are missing.** Unicode mathematical bold does not include numbers in all styles. Subscript has only a limited set of available letters. The [fancy text generator](https://flipmycase.com/fancy-text-generator) shows which characters are available for each style.
...
Instagram has no built-in bold formatting for bios or captions. You need to use a Unicode text generator to create bold characters that you can paste into Instagram. Go to a tool like [FlipMyCase](https://flipmycase.com/bold-text-generator), type your text, select the bold style, and copy the output. Paste it directly into your Instagram bio or caption. The bold characters are actual Unicode code points, not formatting, so they persist anywhere.
...
Generate bold, italic, strikethrough, and dozens of other Unicode text styles instantly at [FlipMyCase](https://flipmycase.com) — free, no signup, works in your browser.
