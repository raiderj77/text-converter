...
check(footer.includes('href="/privacy-and-testing"') && privacy.includes('href="/privacy-and-testing"') && terms.includes('href="/privacy-and-testing"') && sitemap.includes('"privacy-and-testing"') && llms.split(/\r?\n/).some((line) => line === "- [Privacy & Test Center](https://flipmycase.com/privacy-and-testing): Reviewed tool and storage inventory with limited, user-triggered implementation samples"), "privacy and test center is discoverable from trust and machine-readable surfaces");
