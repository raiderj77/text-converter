...
### Output
Save to: `content/content/research/serp-analysis-[topic-slug]-[YYYY-MM-DD].md`
...
### Output
Save to: `content/content/research/social-research-[topic-slug]-[YYYY-MM-DD].md`
...
### Output
Save to: `content/content/research/article-plan-[topic-slug]-[YYYY-MM-DD].md`
...
5. If still < 70 after 2 iterations → move to `content/review-required/`
