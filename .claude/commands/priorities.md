...
- Generate detailed report in `content/research/quick-wins-YYYY-MM-DD.md`
...
- `content/research/quick-wins-YYYY-MM-DD.md` (auto-generated by script)

The command creates:
- `content/content/research/priorities-YYYY-MM-DD.md` (summarized top 10 list)
